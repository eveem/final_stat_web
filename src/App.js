  ...
  return (
    <div className="App">
      ...
      <div style={{display: 'flex', flexDirection: 'row', position: 'absolute', left: '10px', top: '550px'}}>
        ...
        <div class="card">
          <div class="card-main"><h1>เปรียบเทียบแต่ละกระทรวง</h1><p>เปรียบเทียบแต่ละปี</p></div>
          <div class="card-stat">
            <Chart
              width={'320px'}
              height={'300px'}
              chartType="LineChart"
                loader={<div>Loading Chart</div>}
                data={[
                  ['ปี', 'กระทรวงการคลัง', 'กระทรวงการท่องเที่ยวและกีฬา',	'กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์', 'กระทรวงเกษตรและสหกรณ์', 'กระทรวงคมนาคม', 'กระทรวงทรัพยากรธรรมชาติและสิ่งแวดล้อม', 'กระทรวงมหาดไทย', 'กระทรวงยุติธรรม', 'กระทรวงแรงงาน', 'กระทรวงวัฒนธรรม',	'กระทรวงศึกษาธิการ',	'กระทรวงสาธารณสุข',	'รัฐวิสากิจ'],
                  ['2547', 11954722, 424100, 28496789, 335761021, 326370837, 463830983, 387774064, 74831010, 16130401, 1614200, 1145435486, 209543424, 1755000],
                  ['2548', 28283840, 297900, 29618600, 272304989, 356979791, 194594232, 283204746, 76405089, 26714505, 6714624, 2502345925, 197721535, 286437752],
                  ['2549', 35671460, 1289000, 69200, 348464723, 482806178, 69673675, 539244720, 138523881, 20296705, 36176272, 1548396819, 671771030, 11840000],
                  ['2550', 24625340, 207600, 5260860, 2026411743, 150247850, 13016052, 763054744, 105317778, 20134590, 34325961, 1754433650, 128092356, 82845200],
                  ['2551', 37890492, 5700000, 5047210, 2580062772, 126716000, 31570590, 535467807, 180319665, 19487615, 14224800, 1989832452, 66482100, 78853100],
                  ['2552', 16624766, 1118200, 4494265, 1281808659, 320544350, 53087510, 382573954, 164841080, 18004787, 2063000, 1763566400, 35675016, 15469800],
                  ['2553', 10568424, 6125680, 3391990, 1049789488, 245633178, 5933983, 866061625, 172786024, 14910955, 29295460, 1850346600, 81625888, 9751000],
                  ['2554', 16203386, 2434421, 5635705, 905635106, 486674479, 93356579, 495317684, 172250800, 18358252, 2454280, 2254060828, 42326034, 9580550],
                  ['2555', 10465880, 1503004, 3394895, 704690533, 451031200, 35804817, 68981800, 186443953, 24481579, 2803400, 1928682326, 330411803, 6106700],
                  ['2556', 35460200, 37250000, 4733220, 340565712, 901099750, 227817039, 1624214641, 332058030, 12680470, 21127100, 2316312984, 296815750, 67208300],
                  ['2557', 19957500, 1939000, 4327104, 528713675, 877883750, 230416045, 1777336415, 281372530, 19498746, 1322700, 3093960286, 70790800, 11719650],
                  ['2558', 7849900, 14145000, 10030100, 861298558, 1887259056, 431761554, 2118223251, 219406593, 28100311, 7201200, 3492837585, 480252938, 31638050],
                  ['2559', 4666300, 3954500, 13754500, 728780920, 1330742100, 335929370, 3431550897, 137998300, 1447000, 92000, 3261827080, 430066900, 49944600],
                  ['2560', 7356500, 71000, 14656000, 586580145, 1277179500, 287096780, 495206000, 11018700, 4335600, 2500000, 3367665580, 454807400, 40504400],
                  ['2561', 1523200, 1345200, 48835700, 796461800, 1714259600, 235389000, 628331600, 25362200, 2958300, 23115400, 4566975583, 503295700, 39119100],
                  ['2562', 11872700, 236100, 13723600, 809656300, 1777447700, 222586900, 707243400, 96110200, 4822400, 12820600, 4292918934, 400202700, 54871300],
                ]}
                options={{
                  hAxis: {
                    title: 'ปี',
